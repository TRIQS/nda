...
TEST(DEVBLAS, gemm) { test_gemm<double, C_layout>(); }     //NOLINT
TEST(DEVBLAS, gemmF) { test_gemm<double, F_layout>(); }    //NOLINT
TEST(DEVBLAS, zgemm) { test_gemm<dcomplex, C_layout>(); }  //NOLINT
TEST(DEVBLAS, zgemmF) { test_gemm<dcomplex, F_layout>(); } //NOLINT
...
TEST(DEVBLAS, gemm_batch) { test_gemm_batch<double, C_layout>(); }     //NOLINT
TEST(DEVBLAS, gemmF_batch) { test_gemm_batch<double, F_layout>(); }    //NOLINT
TEST(DEVBLAS, zgemm_batch) { test_gemm_batch<dcomplex, C_layout>(); }  //NOLINT
TEST(DEVBLAS, zgemmF_batch) { test_gemm_batch<dcomplex, F_layout>(); } //NOLINT
...
TEST(DEVBLAS, gemm_vbatch) { test_gemm_vbatch<double, C_layout>(); }     //NOLINT
TEST(DEVBLAS, gemmF_vbatch) { test_gemm_vbatch<double, F_layout>(); }    //NOLINT
TEST(DEVBLAS, zgemm_vbatch) { test_gemm_vbatch<dcomplex, C_layout>(); }  //NOLINT
TEST(DEVBLAS, zgemmF_vbatch) { test_gemm_vbatch<dcomplex, F_layout>(); } //NOLINT
#endif
...
void test_gemv() {
  ...
  nda::devvector<value_t> MC_d{MC}, MB_d{MB};
...
TEST(DEVBLAS, gemv) { test_gemv<double, C_layout>(); }     //NOLINT
TEST(DEVBLAS, gemvF) { test_gemv<double, F_layout>(); }    //NOLINT
TEST(DEVBLAS, zgemv) { test_gemv<dcomplex, C_layout>(); }  //NOLINT
TEST(DEVBLAS, zgemvF) { test_gemv<dcomplex, F_layout>(); } //NOLINT
...
TEST(DEVBLAS, dger) { test_ger<double, C_layout>(); }    //NOLINT
TEST(DEVBLAS, dgerF) { test_ger<double, F_layout>(); }   //NOLINT
TEST(DEVBLAS, zger) { test_ger<dcomplex, C_layout>(); }  //NOLINT
TEST(DEVBLAS, zgerF) { test_ger<dcomplex, C_layout>(); } //NOLINT

//----------------------------

TEST(DEVBLAS, outer_product) { //NOLINT
...
TEST(DEVBLAS, ddot) { test_dot<double>(); }   //NOLINT
TEST(DEVBLAS, zdot) { test_dot<dcomplex>(); } //NOLINT
...
TEST(DEVBLAS, ddotc) { test_dotc<double>(); }   //NOLINT
TEST(DEVBLAS, zdotc) { test_dotc<dcomplex>(); } //NOLINT
